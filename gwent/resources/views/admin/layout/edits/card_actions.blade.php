...
<?php
$charac = unserialize($action[0]['html_options']);
?>
<div class="main-central-wrap">
    <input name="action_id" type="hidden" value="{{ $action[0]['id'] }}">
    ...
    <fieldset>
        ...
        <table class="edition" style="width: 100%;">
            <tr>
                ...
                <td><input name="action_title" type="text" value="{{ $action[0]['title'] }}"</td>
            </tr>
            <tr>
                <td><label>Описание:</label></td>
                <td><textarea name="action_descr">{{ $action[0]['description'] }}</textarea></td>
            </tr>
        </table>
    ...
    <input name="cardActionEdit" type="button" value="Применить">
</div>
@stop